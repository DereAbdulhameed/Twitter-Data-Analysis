...
sampletweetsjsonfile = r"C:\Users\HP\Desktop\10Academy\Twitter-Data-Analysis\data\sample_data.json"   #put here the path to where you placed the file e.g. ./sampletweets.json. 
